...
<section class="package" id="package">
    ...
    <div class="package-content">
        ...
        <div class="box">
            <div class="image">
                <img src="{{asset('blog/files/everest.jpeg')}}" alt="">
                <h3>Everest</h3>
            </div>
            <div class="stars">
            ...
            <div class="dest-content">
                ...
                <ul class="pac-details">
                    <li>height 8.848,86m</li>
                    <li>Mount Everest (other name: Chomolungma peak) is located in the Mahalangur Himal massif of the Himalayas, is the highest mountain peak on Earth above sea level, up to the present time is 8848.86 meters, it has decreased in height by 2.4 cm after the earthquake in Nepal on April 25, 2015 and moved 3 cm to the southwest. The border between Nepal and China (Tibet) runs through Mount Everest. <br>

                    The current official altitude is 8,848.86 m (29,032 ft), recognized by China and Nepal, established by a 1955 Indian survey and confirmed by a 1975 Chinese survey. Quoc. <br>
                    
                    In 1865, Everest was given its official English name by the Royal Geographical Society, on the recommendation of Andrew Waugh, British Surveyor General of India, who chose his predecessor's name in the post, Sir George Everest, despite Everest's objections.</li>
                </ul>
                </div>
            </div>
        </div>
